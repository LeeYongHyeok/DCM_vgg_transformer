...
@register_model("avsr_vggtransformer_av_align")
class VGGTransformerModel_av_align(BaseFairseqModel):
    """
    ...
    def forward_decoder(self, prev_output_tokens, audio_encoder_outs, video_encoder_outs, incremental_state, **kwargs):
        av_encoder_out, av_attn = self.av_attn(
                query=audio_encoder_outs["encoder_out"],
                key=video_encoder_outs["encoder_out"],
                value=video_encoder_outs["encoder_out"],
                static_kv=True,
                need_weights=True,
                )
...
@register_model_architecture("avsr_vggtransformer_av_align", "BiModalvggtransformer_avsr_av_align_base")
def BiModalvggtransformer_avsr_av_align_base(args):
